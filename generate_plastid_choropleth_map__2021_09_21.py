...
__copyright__ = 'Copyright (C) 2021 Michael Gruenstaeudl and Tilman Mehl'
__info__ = 'Create map of plastid genomes origins per country.'
__version__ = '2021.07.09.1045'
...
def main(args):
    ...
    map_data = pd.DataFrame(cc_categories.items(), columns=["iso_alpha", "Plastid genome records"])
    cat_order = {"Plastid genome records": [">100", "50-100", "10-50", "1-10"]}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--title", type=str, required=False, default="Geographic origin of plastid genome records", help="title of the output map")
